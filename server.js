...
let eventEmbeddings = [];
const embeddingsPath = path.join(__dirname, 'public', 'event_embeddings.json');
...
if (fs.existsSync(embeddingsPath)) {
  ...
  console.warn('Event embeddings not found. Run generate_embeddings.py first.');
}
...
Count the events you mentioned in your response and verify you have the same number in the RECOMMENDATIONS JSON.`;
    ...
    // Estimate token count for debugging (rough: 1 token ≈ 4 chars)
